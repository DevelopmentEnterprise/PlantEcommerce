    ...
    <main class="page-component">
        ...
        <div class="good-discounts content-section">
            <div class="sector-header">
                <a href="">Товары с нереальной скидкой!</a>
            </div>
            ...
            <div class="trigger-btn-large-cont" style="margin-top: 80px;">
                <div class="view-more-btn trigger-btn-large">
                    Показать еще
                </div>
            </div>
        </div>
...
<%--        <c:if test="${SecurityContextHolder.getContext().getAuthentication().getPrincipal() !}">--%>
<%--            --%>
<%--        </c:if>--%>
